...
import br.com.bradesco.web.ibpj.view.pix.gerenciamento.bean.GerenciamentoForm;
import br.com.bradesco.web.ibpj.view.utils.NavegacaoUtils;

public class ConfirmacaoDadosQrCodeBean {

	public static final String NAV_CONFIRMACAO_DADOS_QRCODE = "confirmacaoDadosQrCode";
	...
	public String init() {
		...
		return NAV_CONFIRMACAO_DADOS_QRCODE;
	}
